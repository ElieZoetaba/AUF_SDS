...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3961494012ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sds&table=etudiant">`sds`.`etudiant`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sds&table=tuteur">`sds`.`tuteur`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sds&table=admin">`sds`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=wordpress&table=wp_users">`wordpress`.`wp_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simplonAdmin&table=admin">`simplonAdmin`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=simplonAdmin&table=abonne">`simplonAdmin`.`abonne`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=demo&table=etudiant">`demo`.`etudiant`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="sds" targettable="etudiant">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `etudiant` (`id`, `user`, `email`, `naissance`, `tutId`, `telephone`) VALUES (&#039;2&#039;, &#039;christian&#039;, &#039;christian0@gmail.com&#039;, &#039;2011-05-11&#039;, &#039;1&#039;, &#039;62686231&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sds" targettable="etudiant">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `etudiant`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sds" targettable="tuteur">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `sds`.`etudiant` WHERE `id` = 1</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sds" targettable="etudiant">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `sds`.`tuteur` WHERE `id` = 7</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sds" targettable="etudiant">
                            <div class="action_content">
